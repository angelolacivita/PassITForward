...
<head>
    ...
    <title>passITforward - Login Successful</title>
...
<div class="jumbotron">
    <div class="container">
        ...
        <p>
            <a href="https://slack.com/oauth/authorize?&client_id=223829578051.223904316370&scope=chat:write:user,users.profile:read,users:read">
