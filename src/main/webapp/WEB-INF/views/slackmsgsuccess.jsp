...
<head>
    ...
    <title>passITforward - Slack Message Success</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-3 info">
                <h5>Information</h5>
                <p> We created passITforward as an alternative to some of the more popular solution websites that don't reward well thought out responses. Our goal is to create a site that encourages users to respond to others problems.
                </p>
            </div>
        </div>
    </div>
