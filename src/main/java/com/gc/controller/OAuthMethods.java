...
public class OAuthMethods {
    ...
    /**Send a private message using fully authenticated slack user
     * @param token generated by getOAuthToken
     * @param slackmessage Message to send
     * @param channel person to send it to
     * @param userId sender of message
     */
